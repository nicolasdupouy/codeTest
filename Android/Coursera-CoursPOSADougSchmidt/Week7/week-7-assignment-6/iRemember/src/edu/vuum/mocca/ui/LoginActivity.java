...
public class LoginActivity extends StoryActivityBase {
	...
	// CHANGE HERE ! (commented because useless)
	...
	public static File getLoginFile(Context context) {
		return StorageUtilities.getOutputMediaFile(context, // Line 48
				...
				StorageUtilities.SECURITY_PRIVATE, // StorageUtilities.SecurityEnum.PRIVATE,
				/* CHANGE HERE ! 
				 * It should be "StorageUtilities.SecurityEnum.PRIVATE", but the assignment explicitly ask
				 * to only includes changes in LoginActivity.java and AndroidManifest.xml.
				 */
				"login.txt");
	}
	...
	public void loginClicked(View v) {
		...
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter(loginFile)); // Line
																					// 113
